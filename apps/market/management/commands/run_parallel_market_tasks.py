# execute without the need for beat and worker spin up
# execute with: python manage.py run_parallel_market_tasks

# apps/market/management/commands/run_parallel_market_tasks.py
